# Operator Quickstart — Other activities auxiliary to insurance and pension funding

Shortest path from clone to a verified local dry-run for **ISIC 6629** (`cloud-itonami-isic-6629`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6629.git
cd cloud-itonami-isic-6629
```
...
- Blueprint governor key: `insurance-auxiliary-governor`
- Likely source path: `auxiliary.governor.cljc`
